...
describe("CreateProcessCommand", () => {
  ...
  let mockCreateProcess: any; // eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  describe("parametersSchema", () => {
    it("should accept empty parameters", () => {
      const schema = (command as any).parametersSchema; // eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  describe("execute", () => {
    ...
    it("should pass correct signer to createProcess", async () => {
      ...
      const customKeyPair = { custom: "key", kty: "RSA" } as any; // eslint-disable-line @typescript-eslint/no-explicit-any
